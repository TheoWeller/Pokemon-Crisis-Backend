class Api::V1::PokemonsController < ApplicationController
  ...
  #this method selects pokemon of a certain type to allow for balanced collection of pokemon to pick from
  ...
  #this method evaluatesn and shapes our pokemon data
